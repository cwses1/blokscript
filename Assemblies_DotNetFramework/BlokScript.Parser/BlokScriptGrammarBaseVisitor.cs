...
public partial class BlokScriptGrammarBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IBlokScriptGrammarVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitDatasourceConstraintList([NotNull] BlokScriptGrammarParser.DatasourceConstraintListContext context) { return VisitChildren(context); }
	/// <summary>
